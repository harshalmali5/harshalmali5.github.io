...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['Face_recognition_based_attendance_system'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
    linkedin: 'harshal-mali',
    twitter: '_Frost_MZ4_',
    mastodon: '',
    facebook: '',
  ...
  resume: {
    fileUrl:
      'http://sgptrms.rf.gd/dummy.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Cyber Security',
    'Machine Learning',
  ...
  externalProjects: [
    
    {
      title: 'Whitecloud PM',
      description:
        'Developed "White Cloud PM," a personalized real estate website catering to property management firm based in Dallas, TX',
      ...
      link: 'https://www.whitecloudpm.com/',
    },
  ],/*
